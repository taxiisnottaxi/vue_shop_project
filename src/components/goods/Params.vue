                    ...
                    <el-table :data="manyTableData" border stripe>
                        ...
                        <el-table-column label="操作">
                            ...
                            <!-- <template> -->
                                ...
                                <el-button type="danger" icon="el-icon-delete" size="mini"  @click="removeEditDialog(scope.row.attr_id)">删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-tab-pane>
...
export default {
    data() {
        return {
            ...
            // 添加表单的验证规则对象
            addFormRules: {
                attr_name: [{required: true, massage: '请输入参数名称', trigger: 'blur'}]
            },
            // 控制修改对话框的显示与隐藏
    ...
    methods: {
        ...
        showInput(row) {
            ...
            // 让文本框自动获得焦点
            // $nextTick方法的作用：就是当页面中元素被重新渲染之后，才会指定回调函数中的代码
            // 上面这个布尔值渲染为true的时候，页面中的元素还没有被重新渲染，$nestTick就是这个渲染完成的时机
            this.$nextTick(_ => {
